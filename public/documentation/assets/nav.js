  ...
  var GROUPS = [
    ...
    { title: "Workspace", items: [
      ...
      { file: "crm.html", title: "CRM", icon: "👥", children: [
        ...
        { file: "crm-deals.html", title: "Deals & Pipeline" },
        { file: "crm-installed-base.html", title: "Warranties & Service" },
      ...
      { file: "finance.html", title: "Finance & Invoicing", icon: "💶", children: [
        ...
        { file: "finance-settings.html", title: "Settings", children: [
          ...
          { file: "finance-compliance.html", title: "Compliance (CBAM · EPR · ΨΔΑ)" },
        ]},
      ]},
    ...
    { title: "Business Apps", items: [
      ...
      { file: "real-estate.html", title: "Real Estate", icon: "🏢", children: [
        { file: "real-estate-listings.html", title: "Listings & workbench" },
        { file: "real-estate-leads.html", title: "Leads & matching" },
        { file: "real-estate-sales.html", title: "Viewings, offers & sales" },
        { file: "real-estate-lettings.html", title: "Property Management" },
        { file: "real-estate-investments.html", title: "Investments" },
        { file: "real-estate-syndication.html", title: "Portal syndication" },
      ]},
      { file: "stock.html", title: "Warehouse", icon: "📦" },
