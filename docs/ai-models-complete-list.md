...
**Environment variables**: `SLIG_ENDPOINT_URL`, `SLIG_ENDPOINT_TOKEN`, `SURYA_ENDPOINT_URL`, `SURYA_ENDPOINT_NAME`, `SURYA_NAMESPACE` (the latter three cover the Surya-2 structural-pass endpoint described below).
...
- **Per-attempt metrics**: `surya_ocr_metrics` table
- **Endpoint**: HuggingFace Inference (eu-west-1), auto-pause/scale-to-zero
