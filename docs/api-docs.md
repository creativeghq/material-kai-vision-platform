...
- color_aspect_1024 / image_color_embeddings (12.5%) - Color matching (Voyage 1024D of `VisionAnalysis.colors[]`, post-2026-05-04 — see [aspect-embeddings-v2-runbook.md](aspect-embeddings-v2-runbook.md); was `color_slig_768` 768D SLIG-blend pre-v2)
- texture_aspect_1024 / image_texture_embeddings (12.5%) - Texture matching (Voyage 1024D of `VisionAnalysis.textures[] + finish`, post-v2; was `texture_slig_768` 768D pre-v2)
- style_aspect_1024 / image_style_embeddings (12.5%) - Style matching (Voyage 1024D of `VisionAnalysis.style + surface_pattern + applications`, post-v2; was `style_slig_768` 768D pre-v2)
- material_aspect_1024 / image_material_embeddings (12.5%) - Material matching (Voyage 1024D of `VisionAnalysis.material_type + category + subcategory`, post-v2; was `material_slig_768` 768D pre-v2)
