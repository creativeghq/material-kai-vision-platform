#!/usr/bin/env python3
"""Fix the pdf_processing_results creation to include user_id."""
...
# Replace the pdf_result_data dictionary to include user_id
old_data = '''                    pdf_result_data = {
                        'id': document_id,
...
if old_data in content:
    ...
    with open(file_path, 'w') as f:
        f.write(content)
    print('Fixed pdf_processing_results user_id')
else:
