            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  <Badge className="ml-auto border border-gray-300 bg-gray-50 text-gray-700">
                    AI-Powered
                  </Badge>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onKeyPress={(e) =>
                      e.key === 'Enter' && handleEnhancedSearch()
                    }
                    className="flex-1"
                  />
                  <Button
                    ...
                    <Input
                      ...
                      onKeyPress={(e) => {
                        if (e.key === 'Enter') {
                          ...
                          if (
                            value &&
                            !context.stylePreferences.includes(value)
                          ) {
                            setContext((prev) => ({
                              ...prev,
                              stylePreferences: [
                    ...
                    <Input
                      ...
                      onKeyPress={(e) => {
                        if (e.key === 'Enter') {
                          ...
                          if (
                            value &&
                            !context.materialCategories.includes(value)
                          ) {
                            setContext((prev) => ({
                              ...prev,
                              materialCategories: [
                        ...
                        <Badge
                          ...
                          onClick={() =>
                            setContext((prev) => ({
                              ...prev,
                              materialCategories:
                                prev.materialCategories.filter(
                                  (_, idx) => idx !== i,
                                ),
                            }))
                          }
                  ...
                  <Card>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4 text-sm text-muted-foreground">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            Complexity:{' '}
                            {(
                              searchResults.semanticAnalysis.queryComplexity *
                              100
                            ).toFixed(0)}
                            %
                          </span>
                      ...
                      <div className="space-y-2">
                          ...
                          {Object.entries(
                            ...
                            if (Array.isArray(values) && values.length > 0) {
                              return values.map((value, i) => (
                                <Badge
                                  key={`${key}-${i}`}
                                  className="text-xs border border-border bg-background text-foreground"
                                >
                                  {key}: {value}
                                </Badge>
                              ));
                        ...
                        {searchResults.semanticAnalysis.suggestedRefinements
                          .length > 0 && (
                          <div className="flex flex-wrap gap-2">
                      ...
                      <Tabs defaultValue="knowledge" className="w-full">
                        <TabsList className="grid grid-cols-4 w-full">
                          ...
                          >
                            ...
                            Knowledge (
                            {searchResults.results.knowledgeBase.length})
                          </TabsTrigger>
                          <TabsTrigger
                            value="materials"
                            className="flex items-center gap-2"
                          >
                            ...
                            Materials (
                            {searchResults.results.materialKnowledge.length})
                          </TabsTrigger>
                          <TabsTrigger
                        ...
                        <TabsContent value="knowledge" className="space-y-4">
                          {searchResults.results.knowledgeBase.length === 0 ? (
                            ...
                            searchResults.results.knowledgeBase.map(
                              (result, index) => (
                                <Card
                                  key={index}
                                  ...
                                  <CardContent className="pt-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      Array.isArray(result.metadata.tags)
                                        ? (result.metadata.tags as string[])
                                            .slice(0, 3)
                                  ...
                                  <CardContent className="pt-4">
                                    ...
                                    <p className="text-sm text-muted-foreground mb-3">
                                      {result.extractedKnowledge
                                        ? result.extractedKnowledge.length > 300
                                          ? result.extractedKnowledge.substring(
                                              0,
                                              300,
                                            ) + '...'
                                          : result.extractedKnowledge
                        ...
                        >
                          ...
                          0 ? (
                            ...
                            searchResults.results.recommendations.map(
                              (result, index) => (
                                <Card
                                  key={index}
                                ...
                                >
                                  <CardContent className="pt-4">
                                    <div className="flex items-start justify-between mb-2">
                                      ...
                                      <div className="flex items-center gap-2">
                                        <div
                                          className={`w-2 h-2 rounded-full ${getConfidenceColor(result.score || 0.5)}`}
                                        />
                                        <span className="text-sm text-muted-foreground">
                                          {(
                                            (result.score || 0.5) * 100
                                          ).toFixed(1)}
                                          %
                                        </span>
                                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="material_spec">
                          Material Specification
                        </SelectItem>
                        <SelectItem value="technical_doc">
                          Technical Document
                        </SelectItem>
                        <SelectItem value="expert_knowledge">
                          Expert Knowledge
                        </SelectItem>
                      </SelectContent>
                    </Select>
                      ...
                      <div className="space-y-3">
                        {trainingStatus.slice(0, 5).map((job, index) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 rounded-full ${getStatusColor(job.status as string)}`}
                              />
                              <Badge className="border border-border bg-background text-foreground">
                    ...
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-primary">
                          ...
                          'totalSearches' in analytics
                            ? ((analytics as Record<string, unknown>)
                                .totalSearches as number) || 0
                            : 0}
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Last 30 days
                    ...
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-primary">
                          {analytics &&
                          typeof analytics === 'object' &&
                          'avgResponseTime' in analytics
                            ? ((analytics as Record<string, unknown>)
                                .avgResponseTime as number) || 0
                            : 0}
                          ms
                        </p>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <Card>
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-primary">
                          {analytics &&
                          typeof analytics === 'object' &&
                          'satisfaction' in analytics
                            ? ((analytics as Record<string, unknown>)
                                .satisfaction as number) || 0
                            : 0}
                          %
                        </p>
                        <p className="text-sm text-muted-foreground">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="text-center space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Embedding generation is handled automatically during
                      material processing. Custom models will be deployed here
