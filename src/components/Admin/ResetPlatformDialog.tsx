  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        {/* Scrollable body — the delete/preserve breakdown is long, so it scrolls
            independently while the header, confirm input, and footer stay pinned. */}
        <div className="flex-1 min-h-0 overflow-y-auto text-left space-y-4 pr-1">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
            ...
            <li>Storage files (<strong>pdf-tiles</strong> and <strong>generation-images</strong> buckets; catalog/quote/client-view output in pdf-documents is orphan-reaped). Admin branding under <span className="font-mono">business-logos/</span> is preserved.</li>
          ...
          <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
            ...
            <li><strong>Sheet reference illustrations</strong> (the generated example image for each presentation-sheet type, in the <span className="font-mono">moodboard-sheet-references</span> bucket)</li>
            <li><strong>User Avatars</strong> (profile pictures in profile-avatars)</li>
            <li><strong>Price Monitoring</strong> (tracked queries, price history, alert log, classifier cache, brand-retailer index, extraction recipes — long-running trend data and customer-facing API state)</li>
          </ul>
        </div>
