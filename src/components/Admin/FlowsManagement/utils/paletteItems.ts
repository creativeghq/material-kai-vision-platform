...
import { TENANT_TRIGGERS, TENANT_ACTIONS, PALETTE_ACTION_ALIASES } from '@/services/flows/tenantVocabulary';
...
export const paletteItems: NodePaletteItem[] = [
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'inbox.thread_labeled', group: 'Inbox',
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'inbox.follow_up_due', group: 'Inbox',
    ...
    defaultData: { label: 'Inbox Follow-up Due', category: 'trigger', triggerType: 'inbox.follow_up_due', config: {} } as TriggerNodeData },
  ...
  // Expenses and the cash plan
  { type: 'triggerNode', category: 'trigger', subType: 'expense.booked', group: 'Finance',
    label: 'Expense Booked', description: 'A received myDATA document became a supplier bill', icon: 'ReceiptText', color: 'emerald',
    defaultData: { label: 'Expense Booked', category: 'trigger', triggerType: 'expense.booked', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'expense.settled_outside', group: 'Finance',
    label: 'Expense Settled Outside the Books', description: 'A cost was marked paid outside the platform and kept out of the P&L', icon: 'BadgeCheck', color: 'emerald',
    defaultData: { label: 'Expense Settled Outside the Books', category: 'trigger', triggerType: 'expense.settled_outside', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'credit_note.received', group: 'Finance',
    label: 'Supplier Credit Note Received', description: 'Credit notes a supplier issued you were brought in from myDATA', icon: 'Undo2', color: 'emerald',
    defaultData: { label: 'Supplier Credit Note Received', category: 'trigger', triggerType: 'credit_note.received', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'plan.due_tomorrow', group: 'Finance',
    label: 'Planned Payment Due Tomorrow', description: 'A scheduled payment or expected receipt falls due tomorrow', icon: 'CalendarClock', color: 'emerald',
    defaultData: { label: 'Planned Payment Due Tomorrow', category: 'trigger', triggerType: 'plan.due_tomorrow', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'vat.return_ready', group: 'Finance',
    label: 'VAT Return Ready', description: 'A closed period has figures on both sides and can be filed', icon: 'Landmark', color: 'emerald',
    defaultData: { label: 'VAT Return Ready', category: 'trigger', triggerType: 'vat.return_ready', config: {} } as TriggerNodeData },
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'self_hosting_requested', group: 'Modules',
    label: 'Self-Hosting Requested', description: 'Someone asked to run the platform on their own infrastructure', icon: 'LayoutGrid', color: 'violet',
    defaultData: { label: 'Self-Hosting Requested', category: 'trigger', triggerType: 'self_hosting_requested', config: {} } as TriggerNodeData },
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'order_awaiting_invoice', group: 'Finance',
    label: 'Order Not Invoiced', description: 'A confirmed or delivered sale has no invoice, or its invoice is still a draft', icon: 'ReceiptText', color: 'emerald',
    defaultData: { label: 'Order Not Invoiced', category: 'trigger', triggerType: 'order_awaiting_invoice', config: {} } as TriggerNodeData },
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'review_received', group: 'Social',
    label: 'Review Received', description: 'A review was left on a connected Google Business profile', icon: 'Star', color: 'amber',
    defaultData: { label: 'Review Received', category: 'trigger', triggerType: 'review_received', config: {} } as TriggerNodeData },
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'project_task_completed', group: 'Projects',
    label: 'Task Completed', description: 'A task on a job was marked done', icon: 'CheckCircle2', color: 'emerald',
    defaultData: { label: 'Task Completed', category: 'trigger', triggerType: 'project_task_completed', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'project_milestone_reached', group: 'Projects',
    label: 'Milestone Reached', description: 'A task marked as a milestone was completed', icon: 'Flag', color: 'emerald',
    defaultData: { label: 'Milestone Reached', category: 'trigger', triggerType: 'project_milestone_reached', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'project_snag_raised', group: 'Projects',
    label: 'Snag Raised', description: 'A defect was raised on site', icon: 'AlertTriangle', color: 'emerald',
    defaultData: { label: 'Snag Raised', category: 'trigger', triggerType: 'project_snag_raised', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'project_expense_approved', group: 'Projects',
    label: 'Expense Approved', description: 'An expense was approved as a cost on a job', icon: 'BadgeCheck', color: 'emerald',
    defaultData: { label: 'Expense Approved', category: 'trigger', triggerType: 'project_expense_approved', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'project_delivery_issued', group: 'Projects',
    label: 'Delivery Issued', description: 'A delivery note was issued on a job', icon: 'Truck', color: 'emerald',
    defaultData: { label: 'Delivery Issued', category: 'trigger', triggerType: 'project_delivery_issued', config: {} } as TriggerNodeData },
  { type: 'triggerNode', category: 'trigger', subType: 'project_asset_registered', group: 'Projects',
    label: 'Equipment Registered', description: 'A unit of installed base was registered on a job', icon: 'Wrench', color: 'emerald',
    defaultData: { label: 'Equipment Registered', category: 'trigger', triggerType: 'project_asset_registered', config: {} } as TriggerNodeData },
  ...
  { type: 'triggerNode', category: 'trigger', subType: 'seo.report_ready', group: 'Monitoring',
    label: 'SEO Report Ready', description: 'A scheduled SEO report finished building and is ready to send', icon: 'Search', color: 'blue',
    defaultData: { label: 'SEO Report Ready', category: 'trigger', triggerType: 'seo.report_ready', config: {} } as TriggerNodeData },
