...
const EDGE_FUNCTIONS: EntityResult[] = [
  ...
  { id: 'catalog-export', label: 'catalog-export', sublabel: 'Export the workspace catalogue as CSV, JSON or XML for a distributor or channel' },
  ...
  { id: 'inbox-draft-cron', label: 'inbox-draft-cron', sublabel: 'Every-2-minute cron: pre-write the AI reply on threads set to suggesting, so a member finds a draft waiting instead of an empty composer' },
  ...
  { id: 'intake-enrich-products', label: 'intake-enrich-products', sublabel: 'Drain the products intake marked for enrichment, from a URL we already hold' },
  ...
  { id: 'trade-portal', label: 'trade-portal', sublabel: 'A trade customer seeing their own account: statement, stock bands, reorder and a delegated admin' },
