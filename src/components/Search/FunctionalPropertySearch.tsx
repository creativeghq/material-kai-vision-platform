...
interface FunctionalPropertySearchProps {
  ...
  availableMaterials?: Array<{ id: string; functionalMetadata?: FunctionalMetadata }>;
...
const FUNCTIONAL_CATEGORIES = {
  slipSafetyRatings: {
    ...
    searchableProperties: ['rValue', 'barefootRampTest', 'dcof', 'pendulumTestValue', 'safetyCertifications'],
  },
  surfaceGlossReflectivity: {
    icon: Star,
    ...
    searchableProperties: ['glossLevel', 'glossValue', 'lightReflectance', 'surfaceFinish', 'reflectivityProperties', 'antiGlareRating', 'mirrorFinish'],
  },
  mechanicalPropertiesExtended: {
    icon: Hammer,
    ...
    searchableProperties: ['mohsHardness', 'peiRating', 'breakingStrength', 'impactResistance', 'mechanicalCertifications'],
  },
  thermalProperties: {
    icon: Thermometer,
    ...
    searchableProperties: ['thermalConductivity', 'thermalExpansionCoefficient', 'heatResistance', 'coolRoofRating', 'solarReflectance', 'sriValue', 'radiantHeatingCompatible', 'thermalShockResistance'],
  },
  waterMoistureResistance: {
    icon: Droplets,
    ...
    searchableProperties: ['waterAbsorption', 'waterAbsorptionPercentage', 'waterAbsorptionClassification', 'frostResistance', 'hydrophobicTreatment', 'moldMildewResistant', 'moistureCertifications'],
  },
  chemicalHygieneResistance: {
    icon: Shield,
    ...
    searchableProperties: ['chemicalResistance', 'acidResistance', 'alkaliResistance', 'stainResistance', 'antimicrobialProperties', 'antimicrobialTreatment', 'foodSafeCertified', 'chemicalCertifications'],
  },
  acousticElectricalProperties: {
    icon: Waves,
    ...
    searchableProperties: ['acousticProperties', 'nrc', 'soundAbsorption', 'decibelReduction', 'impactInsulationClass', 'electricalProperties', 'antiStatic', 'conductive', 'electricalResistance', 'esdCertified', 'acousticCertifications'],
  },
  environmentalSustainability: {
    icon: Leaf,
    ...
    searchableProperties: ['vocEmissionRating', 'greenguard', 'floorScore', 'recycledContent', 'ecoLabels', 'leedCredits', 'breeamCredits', 'sustainabilityMetrics', 'carbonFootprint', 'geopolymerRating', 'recyclable', 'circularMaterialRating'],
  },
  dimensionalAesthetic: {
    icon: Palette,
    ...
    searchableProperties: ['edgeProperties', 'rectifiedEdges', 'calibrationGrade', 'edgeGeometry', 'textureProperties', 'textureDepth', 'textureRating', 'textureType', 'colorProperties', 'shadeVariation', 'colorUniformity', 'colorFastness', 'specialProperties', 'translucent', 'backlitCapability', 'luminescent', 'photoluminescentDuration'],
  },
} as const;

export const FunctionalPropertySearch: React.FC<FunctionalPropertySearchProps> = ({
  filters,
  onFiltersChange,
  ...
  const renderCategorySpecificFilters = useCallback((categoryKey: string) => {
    ...
    switch (categoryKey) {
      case 'slipSafetyRatings': {
        const slipFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['slipSafetyRatings'];
        return (
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{slipFilters?.dcofRange?.[0]?.toFixed(2) || '0.00'}</span>
                <span>{slipFilters?.dcofRange?.[1]?.toFixed(2) || '1.00'}</span>
              </div>
            </div>

            {/* Barefoot Ramp Test */}
            <div className="space-y-1">
              <Label className="text-xs">Barefoot Ramp Test (DIN 51097)</Label>
              <div className="flex flex-wrap gap-1">
                {['A', 'B', 'C'].map(grade => (
                  <Button
                    key={grade}
      ...
      case 'surfaceGlossReflectivity': {
        const glossFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['surfaceGlossReflectivity'];
        return (
          <div className="space-y-3">
            {/* Gloss Level */}
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <Slider
                ...
                onValueChange={(value) => updateCategoryFilter('lightReflectanceRange', value as [number, number])}
                max={100}
                min={0}
                step={1}
                className="w-full"
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span>{glossFilters?.lightReflectanceRange?.[1] || 100}%</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => updateCategoryFilter('mirrorFinish', !!checked)}
              />
      ...
      case 'mechanicalPropertiesExtended': {
        const mechanicalFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['mechanicalPropertiesExtended'];
        return (
          <div className="space-y-3">
            {/* Mohs Hardness Range */}
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{mechanicalFilters?.mohsHardnessRange?.[0]?.toFixed(1) || '1.0'}</span>
                <span>{mechanicalFilters?.mohsHardnessRange?.[1]?.toFixed(1) || '10.0'}</span>
              </div>
            </div>

            {/* PEI Rating */}
            <div className="space-y-1">
              <Label className="text-xs">PEI Rating (Abrasion Resistance)</Label>
              <div className="flex flex-wrap gap-1">
      ...
      case 'thermalProperties': {
        const thermalFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['thermalProperties'];
        return (
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{thermalFilters?.thermalConductivityRange?.[0]?.toFixed(1) || '0.0'}</span>
                <span>{thermalFilters?.thermalConductivityRange?.[1]?.toFixed(1) || '50.0'}</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <Slider
                ...
                onValueChange={(value) => updateCategoryFilter('heatResistanceRange', value as [number, number])}
                max={1000}
                min={0}
                step={10}
                className="w-full"
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span>{thermalFilters?.heatResistanceRange?.[1] || 1000}°C</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => updateCategoryFilter('radiantHeatingCompatible', !!checked)}
              />
      ...
      case 'waterMoistureResistance': {
        const waterFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['waterMoistureResistance'];
        return (
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{waterFilters?.waterAbsorptionRange?.[0]?.toFixed(1) || '0.0'}%</span>
                <span>{waterFilters?.waterAbsorptionRange?.[1]?.toFixed(1) || '20.0'}%</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('frostResistance', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('hydrophobicTreatment', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('moldMildewResistant', !!checked)}
                />
      ...
      case 'chemicalHygieneResistance': {
        const chemicalFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['chemicalHygieneResistance'];
        return (
          <div className="space-y-3">
            {/* Acid Resistance */}
            <div className="space-y-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('antimicrobialTreatment', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('foodSafeCertified', !!checked)}
                />
      ...
      case 'acousticElectricalProperties': {
        const acousticFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['acousticElectricalProperties'];
        return (
          <div className="space-y-3">
            {/* NRC Range */}
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{acousticFilters?.nrcRange?.[0]?.toFixed(2) || '0.00'}</span>
                <span>{acousticFilters?.nrcRange?.[1]?.toFixed(2) || '1.00'}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('antiStatic', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('conductive', !!checked)}
                />
      ...
      case 'environmentalSustainability': {
        const envFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['environmentalSustainability'];
        return (
          <div className="space-y-3">
            {/* VOC Emission Rating */}
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{envFilters?.totalRecycledContentRange?.[0] || 0}%</span>
                <span>{envFilters?.totalRecycledContentRange?.[1] || 100}%</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <Slider
                ...
                onValueChange={(value) => updateCategoryFilter('leedCreditsRange', value as [number, number])}
                max={10}
                min={0}
                step={1}
                className="w-full"
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  checked={!!envFilters?.greenguardLevel && envFilters.greenguardLevel.length > 0}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('floorScore', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('recyclable', !!checked)}
                />
      ...
      case 'dimensionalAesthetic': {
        const dimensionalFilters = categoryFilters as FunctionalPropertyFilters['propertyFilters']['dimensionalAesthetic'];
        return (
          <div className="space-y-3">
            {/* Texture Depth Range */}
            <div className="space-y-1">
              ...
              />
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>{dimensionalFilters?.textureDepthRange?.[0]?.toFixed(1) || '0.0'}mm</span>
                <span>{dimensionalFilters?.textureDepthRange?.[1]?.toFixed(1) || '10.0'}mm</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('rectifiedEdges', !!checked)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('translucent', !!checked)}
                />
                <Label className="text-xs">Translucent</Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  checked={!!dimensionalFilters?.backlitCapabilityRange &&
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateCategoryFilter('luminescent', !!checked)}
                />
      ...
      default:
        return (
          <div className="text-xs text-muted-foreground italic">
            Advanced filters for {categoryKey} category will be available here.
          </div>
        );
    }
  }, [filters, onFiltersChange]);
  ...
  const renderCategoryFilter = useCallback((categoryKey: string) => {
  ...
  }, [expandedCategories, filters.activeCategories, toggleCategory, handleCategoryToggle]);
    ...
    return (
      <Card className="w-full">
        <CardHeader className="p-4">
          ...
          {/* Active Categories */}
          <div className="space-y-2">
            <Label className="text-xs font-medium">Active Categories ({filters.activeCategories.length})</Label>
            <div className="flex flex-wrap gap-1">
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Functional Metadata Categories</CardTitle>
          <p className="text-sm text-muted-foreground">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t">
                  <div className="text-xs text-muted-foreground">
                    Apply filters to refine search results across selected categories
                  </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">Searching functional properties...</span>
            </div>
          </CardContent>
        </Card>
      )}
