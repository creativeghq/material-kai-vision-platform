...
export const SimilarMaterials = ({ materialId, limit = 10 }: SimilarMaterialsProps) => {
  ...
  useEffect(() => {
    const fetchSimilarMaterials = async () => {
      ...
      // Fetch product details. Note: products only has category_id; image,
      // manufacturer, and category live in metadata or via the image_product_associations
      // join. We resolve them through the shared accessors.
