      ...
      },
      {
        ...
        form: [
          ...
          { key: 'model', label: 'Model', kind: 'select', default: 'veo-2', options: [
            ...
            { value: 'wan-3.0-480p', label: 'Wan3.0 480p — 30s with audio, 40 credits' },
            { value: 'wan-3.0-720p', label: 'Wan3.0 720p — 30s with audio, 80 credits' },
            { value: 'wan-3.0-1080p', label: 'Wan3.0 1080p — 30s with audio, 155 credits' },
