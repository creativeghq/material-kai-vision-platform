    ...
    quick_starts: [
      ...
      },
      {
        ...
        form: [
          ...
          { key: 'duration_seconds', label: 'Duration (seconds)', kind: 'number', default: '8', help: '4–30 seconds; clamped to the model ceiling (Veo 8s, Kling 10s, MiniMax H3 15s, Wan/Seedance 30s)' },
