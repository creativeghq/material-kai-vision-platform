...
>(({ className, ...props }, ref) => {
  // Radix needs one Thumb per value. This used to hardcode a single Thumb, which silently
  // made every two-handle range (the filter modal's min/max) undraggable at the max end.
