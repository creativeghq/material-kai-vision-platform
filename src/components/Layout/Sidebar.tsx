...
import { Home, Palette, Settings, Box, Search, MessageSquare, User, ChevronRight, ChevronLeft, FileText, Cube } from 'lucide-react';
...
const navigationItems = [
  ...
  { id: '3d-designer', label: '3D Designer', path: '/3d-designer', icon: Cube },
