...
const navigationItems = [
  ...
  { id: 'svbrdf', label: 'SVBRDF Extraction', path: '/svbrdf', icon: Layers },
  { id: 'nerf', label: 'NeRF Reconstruction', path: '/nerf', icon: Box },
  { id: 'ocr', label: 'OCR Processing', path: '/ocr', icon: ScanText },
  { id: 'rag', label: 'Enhanced RAG', path: '/rag', icon: Search },
