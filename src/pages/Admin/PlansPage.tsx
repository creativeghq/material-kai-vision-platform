          ...
          <>
            {violations.length > 0 && (
              <Card className="border-amber-500/40 bg-amber-500/5">
                <CardHeader className="flex-row items-start gap-2 space-y-0">
                  ...
                  <div>
                    <CardTitle className="text-base">Dependency warnings</CardTitle>
                    <CardDescription>
            ...
            <Card>
              <CardHeader className="border-b border-border/60 px-5 py-3">
                <CardTitle className="text-sm">Module → plan</CardTitle>
            ...
            <Card>
              <CardHeader className="border-b border-border/60 px-5 py-3">
                <CardTitle className="text-sm">Per-plan limits</CardTitle>
