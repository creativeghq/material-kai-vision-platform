...
export const INVOICE_LABELS: Record<Lang, Record<string, string>> = {
  el: {
    ...
    transmittedVia: 'Διαβίβαση μέσω', posPayment: 'ΠΛΗΡΩΜΗ ΜΕΣΩ POS', posTxn: 'Ταυτότητα Πληρωμής', posTerminal: 'Τερματικό', posSignature: 'Υπογραφή Παρόχου',
  ...
  en: {
    ...
    transmittedVia: 'Transmitted via', posPayment: 'CARD / IRIS PAYMENT', posTxn: 'Payment identity', posTerminal: 'Terminal', posSignature: 'Provider signature',
