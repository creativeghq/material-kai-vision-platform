...
import { Warehouse as WarehouseIcon, LayoutDashboard, Boxes, ArrowLeftRight, ClipboardList, TrendingUp, Ship, Truck, Coins } from 'lucide-react';
...
const TABS = ['overview', 'inventory', 'valuation', 'resupply', 'inbound', 'dispatch', 'movements', 'counts'];
