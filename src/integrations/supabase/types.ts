  ...
  public: {
    Tables: {
      ...
      competitor_sources: {
        Row: {
          ...
          discovered_via:
            | Database["public"]["Enums"]["competitor_source_type"]
            | null
          ...
          source_name: string
          source_type: Database["public"]["Enums"]["competitor_source_type"]
          source_url: string
          updated_at: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "competitor_sources_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      price_monitoring_products: {
        Row: {
          ...
          last_claude_credits_used: number | null
          last_claude_search_at: string | null
          monitoring_enabled: boolean | null
          monitoring_frequency: string | null
          next_check_at: string | null
          product_id: string
          status: string | null
          total_claude_credits_used: number | null
          updated_at: string | null
          user_id: string
          workspace_id: string
        }
        ...
        Relationships: [
          {
            foreignKeyName: "price_monitoring_products_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      update_next_check_time: {
        Args: { p_frequency: string; p_monitoring_id: string }
        Returns: undefined
      }
