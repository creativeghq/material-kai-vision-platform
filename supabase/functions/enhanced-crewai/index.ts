...
// Enhanced CrewAI Agent System with specialized AI agents
class CrewAIAgentOrchestrator {
  ...
  async initializeAgents() {
    ...
    console.log(`Initialized ${this.agents.size} CrewAI agents`);
  }
  
  async executeTask(request: CrewAITaskRequest): Promise<CrewAIResult> {
  ...
  private async selectAgentsForTask(request: CrewAITaskRequest): Promise<any[]> {
  ...
  private async createCoordinationPlan(agents: any[], request: CrewAITaskRequest): Promise<any> {
  ...
  private async synthesizeResults(executions: AgentExecution[], request: CrewAITaskRequest): Promise<any> {
  ...
  private async createTaskRecord(taskId: string, request: CrewAITaskRequest): Promise<void> {
...
serve(async (req) => {
  ...
  try {
    const request: CrewAITaskRequest = await req.json();
    ...
    // Initialize and execute CrewAI orchestrator
    const orchestrator = new CrewAIAgentOrchestrator();
    ...
    console.error('Error in enhanced-crewai function:', error);
    return new Response(
      JSON.stringify({ 
        success: false, 
        error: error.message 
