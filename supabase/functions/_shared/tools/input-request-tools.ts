  ...
  return tool(
    ...
    },
    {
      ...
      description:
        ...
        + 'EVERY field must map to something you can actually do with the answer — a parameter on a '
        + 'tool you hold, or a decision that changes what you call. Asking "which image should I '
        + 'edit?" when no tool takes that argument costs the user a full turn and changes nothing: '
        + 'they answer, you re-run the identical call, and the same thing goes wrong. If you cannot '
        + 'name the parameter an answer would fill, do not offer the field. '
