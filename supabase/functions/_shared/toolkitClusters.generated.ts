...
export const TOOLKIT_CLUSTERS: Record<string, ToolkitCluster> = {
  ...
  'b2b': {
    tool_ids: ['b2b_manufacturer_search', 'company_website_scrape', 'company_registry_lookup', 'industrial_facility_search', 'company_enrichment', 'contact_discovery', 'email_validate', 'save_to_crm', 'scrape_materials_from_url', 'suggest_extraction_fields'],
  },
  'sub-agents': {
