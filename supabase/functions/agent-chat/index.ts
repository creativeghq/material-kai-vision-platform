...
// LangChain imports - using esm.sh with bundle flag for better Deno compatibility
import { ChatAnthropic } from 'https://esm.sh/@langchain/anthropic@0.3.11?bundle&target=deno';
import { tool } from 'https://esm.sh/@langchain/core@0.3.29/tools?bundle&target=deno';
