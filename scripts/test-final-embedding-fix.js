...
/**
 * TEST FINAL EMBEDDING FIX
 * Test the workspace_id UUID fix with a new job
 */
...
async function testFinalEmbeddingFix() {
    console.log('🔧 TEST FINAL EMBEDDING FIX');
    console.log('==================================================');
    ...
    try {
        ...
        const submitResponse = await makeRequest(`${BASE_URL}/api/jobs/submit`, {
            method: 'POST',
            headers: {
                            ...
                            if (chunksResponse.status === 200 && chunksResponse.data.data) {
                                ...
                                if (chunks.length > 0) {
                                    ...
                                    if (chunksWithEmbeddings.length > 0) {
                                        ...
                                        console.log('   - The workspace_id fix may not have resolved the issue');
...
testFinalEmbeddingFix().catch(console.error);
